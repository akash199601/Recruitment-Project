...
def search(request):
    ...
    if request.method == "POST":
        ...
        # minimum = minimum_experience.objects.all()
        # maximum = maximum_experience.objects.all()
        # min1 = request.POST['searched']
        # max1 = request.POST['searched']
...
def post_job(request):
    ...
    if request.method == "POST":
        ...
        minimum_exp_id = request.POST['minimum_exp_id']
        maximum_exp_id = request.POST['maximum_exp_id']
        ...
        job.minimum_exp_id = minimum_exp_id
        job.maximum_exp_id = maximum_exp_id
...
# def applied_job_detail(request,joblisting_id):
#     minimum = minimum_experience.objects.all()
#     maximum = maximum_experience.objects.all()
#     category = Category.objects.all()
#     education = Education.objects.all() 
...
#     joblisting = JobListing.objects.filter(id = joblisting_id)
#     applyjob = ApplyJob.objects.filter(joblisting_id__in=joblisting)
#     return render(request,'applied_job_detail.html',{'joblisting':joblisting,'category':category,'skill':skill,'education':education,'applyjob':applyjob,
#                                              'minimum':minimum,'maximum':maximum })
